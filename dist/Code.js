...
/* harmony export */   authCallback: function() { return /* binding */ authCallback; },
/* harmony export */   clearSiteData: function() { return /* binding */ clearSiteData; },
/* harmony export */   deleteSite: function() { return /* binding */ deleteSite; },
/* harmony export */   devTest: function() { return /* binding */ devTest; },
/* harmony export */   getAuthUrl: function() { return /* binding */ getAuthUrl; },
/* harmony export */   include: function() { return /* binding */ include; },
/* harmony export */   listSites: function() { return /* binding */ listSites; },
/* harmony export */   onInstall: function() { return /* binding */ onInstall; },
/* harmony export */   onOpen: function() { return /* binding */ onOpen; },
/* harmony export */   postToWordPress: function() { return /* binding */ postToWordPress; },
/* harmony export */   refreshSite: function() { return /* binding */ refreshSite; },
/* harmony export */   showSidebar: function() { return /* binding */ showSidebar; }
/* harmony export */ });
/* harmony import */ var _wp_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _doc_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _image_upload_linker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
/* harmony import */ var _image_cache__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var _persistance__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
/* harmony import */ var _date_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16);
/**
 * @OnlyCurrentDoc
 *
...
var wpClient = (0,_wp_client__WEBPACK_IMPORTED_MODULE_0__.WPClient)(PropertiesService, UrlFetchApp);
var store = (0,_persistance__WEBPACK_IMPORTED_MODULE_4__.Persistance)(PropertiesService);
...
function postToWordPress(site_id, _ref) {
  ...
  var imageCache = (0,_image_cache__WEBPACK_IMPORTED_MODULE_3__.ImageCache)(site, docProps, md5);
  var imageUrlMapper = (0,_image_upload_linker__WEBPACK_IMPORTED_MODULE_2__.imageUploadLinker)(upload, imageCache);
  var renderContainer = (0,_doc_service__WEBPACK_IMPORTED_MODULE_1__.DocService)(DocumentApp, imageUrlMapper);
...
function postOnServerIsNewer(site, cachedPost) {
  ...
  var localDate = (0,_date_utils__WEBPACK_IMPORTED_MODULE_5__.getDateFromIso)(cachedPost.modified);
  var serverDate = (0,_date_utils__WEBPACK_IMPORTED_MODULE_5__.getDateFromIso)(serverPost.modified);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WPClient: function() { return /* binding */ WPClient; }
/* harmony export */ });
/* globals Utilities */
...
function WPClient(PropertiesService, UrlFetchApp) {
  function request(access_token, path, options) {
    ...
    return JSON.parse(UrlFetchApp.fetch(url, Object.assign(options, {
      headers: headers
    })));
  }
  function get(access_token, path) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    return request(access_token, path, Object.assign({
      method: 'get'
    }, options));
  }
  ...
  function postToWordPress(site, postIdParam) {
    ...
    var path = "/sites/".concat(blog_id, "/posts/").concat(postId);
    return post(access_token, path, {
      payload: payload
    });
  }
  ...
  function uploadImage(site, image) {
    ...
    var blog_id = site.blog_id,
      access_token = site.access_token;
    var path = "/sites/".concat(blog_id, "/media/new");
  ...
  function getSiteInfo(site) {
    var blog_id = site.blog_id,
      access_token = site.access_token;
    return get(access_token, "/sites/".concat(blog_id));
  }
  function getPostTypes(site) {
    var blog_id = site.blog_id,
      access_token = site.access_token;
    var response = get(access_token, "/sites/".concat(blog_id, "/post-types"));
    return response.post_types || [];
  }
  function getCategories(site) {
    var blog_id = site.blog_id,
      access_token = site.access_token;
    var response = get(access_token, "/sites/".concat(blog_id, "/categories"));
  ...
  function getTaxonomiesForPostType(site, postType) {
    ...
    var response = get(access_token, "/sites/".concat(blog_id, "/post-types/").concat(name, "/taxonomies"));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DocService: function() { return /* binding */ DocService; }
/* harmony export */ });
/* harmony import */ var _paragraph__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var _inlineImage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11);
/* harmony import */ var _text__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(12);
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
...
function DocService(DocumentApp, imageLinker) {
  ...
  var groupListItems = function groupListItems() {
    ...
    return function (processedElements, el) {
      ...
      var list = new _list__WEBPACK_IMPORTED_MODULE_3__.ListElement(listId);
      list.addListItem(el);
  ...
  var renderParagraph = (0,_paragraph__WEBPACK_IMPORTED_MODULE_0__.Paragraph)(DocumentApp, renderContainer);
  var renderTable = (0,_table__WEBPACK_IMPORTED_MODULE_1__.Table)(renderContainer);
  var renderImage = (0,_inlineImage__WEBPACK_IMPORTED_MODULE_2__.InlineImage)(imageLinker);
  var renderList = (0,_list__WEBPACK_IMPORTED_MODULE_3__.List)(DocumentApp, renderContainer);
  var renderHorizontalRule = function renderHorizontalRule(element, renderBlocks) {
    return renderBlocks ? (0,_block__WEBPACK_IMPORTED_MODULE_5__.getCommentDelimitedContent)('core/separator', {}, '<hr>') : '<hr>';
  };
  ...
  function renderElement(element) {
    ...
    switch (element.getType()) {
      ...
      case DocumentApp.ElementType.TEXT:
        return (0,_text__WEBPACK_IMPORTED_MODULE_4__.renderText)(element, renderBlocks);
      ...
      case _list__WEBPACK_IMPORTED_MODULE_3__.LIST_ELEMENT:
...
/* harmony export */ });
/* harmony import */ var _attributes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _tags__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
function Paragraph(DocumentApp, renderContainer) {
  ...
  function renderParagraph(paragraph) {
    ...
    var tag = tagForParagraph(paragraph),
      ...
      openTags = (0,_tags__WEBPACK_IMPORTED_MODULE_1__.changedTags)(paragraph.getAttributes(), _attributes__WEBPACK_IMPORTED_MODULE_0__.blankAttributes),
      closedTags = (0,_tags__WEBPACK_IMPORTED_MODULE_1__.changedTags)(_attributes__WEBPACK_IMPORTED_MODULE_0__.blankAttributes, paragraph.getAttributes()),
      contents = renderContainer(paragraph, false);
    var classAttr = classes ? " class=\"".concat(classes, "\"") : '';
    var content = "<".concat(tag).concat(classAttr, ">") + openTags + contents + closedTags + "</".concat(tag, ">");
    return (renderBlock ? (0,_block__WEBPACK_IMPORTED_MODULE_2__.getCommentDelimitedContent)(blockName, googleAttributesToGutenberg(paragraph), content) : content) + '\n';
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   blankAttributes: function() { return /* binding */ blankAttributes; }
/* harmony export */ });
var blankAttributes = {
  FONT_SIZE: null,
  // TODO
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   changedTags: function() { return /* binding */ changedTags; },
/* harmony export */   quoteattr: function() { return /* binding */ quoteattr; }
/* harmony export */ });
var simpleTagMap = {
  ITALIC: 'i',
  STRIKETHROUGH: 's',
...
function changedTags(elAttributes, prevAttributes) {
  ...
  var tags = '';
  if (diff.LINK_URL) {
    tags += "<a href=\"".concat(quoteattr(diff.LINK_URL), "\">");
  }
...
/* harmony export */ });
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
...
function Table(renderContainer) {
  ...
  return function renderTable(table) {
    ...
    if (renderBlocks) {
      ...
      return (0,_block__WEBPACK_IMPORTED_MODULE_0__.getCommentDelimitedContent)('core/table', attributes, content) + '\n';
    }
    return content;
  };
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   InlineImage: function() { return /* binding */ InlineImage; }
/* harmony export */ });
/* harmony import */ var _tags__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
...
function InlineImage(imageLinker) {
  return function renderInlineImage(image) {
    ...
    var title = image.getAltTitle && image.getAltTitle() ? (0,_tags__WEBPACK_IMPORTED_MODULE_0__.quoteattr)(image.getAltTitle()) : '';
    var alt = image.getAltDescription && image.getAltDescription() ? (0,_tags__WEBPACK_IMPORTED_MODULE_0__.quoteattr)(image.getAltDescription()) : '';
    var content = "<figure><img src=\"".concat(url, "\" width=\"").concat(width, "\" height=\"").concat(height, "\" alt=\"").concat(alt, "\" title=\"").concat(title, "\"></figure>");
    if (renderBlock) {
      var attributes = {
        url: url,
        alt: alt,
      ...
      return (0,_block__WEBPACK_IMPORTED_MODULE_1__.getCommentDelimitedContent)('core/image', attributes, content) + '\n';
    }
    return content;
  };
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LIST_ELEMENT: function() { return /* binding */ LIST_ELEMENT; },
/* harmony export */   List: function() { return /* binding */ List; },
/* harmony export */   ListElement: function() { return /* binding */ ListElement; }
/* harmony export */ });
/* harmony import */ var _attributes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _tags__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
function List(DocumentApp, renderContainer) {
  ...
  var renderList = function renderList(list) {
    ...
    return renderBlock ? (0,_block__WEBPACK_IMPORTED_MODULE_2__.getCommentDelimitedContent)('core/list', {}, content) : content;
  };
  function renderListItem(listItem, nestedListTags) {
    var rendered = '';
    var type = typeForList(listItem),
      typeAttr = type ? " type=\"".concat(type, "\"") : '';
    ...
    if (previousIsMoreNested) {
      ...
      while (nestingLevel > targetLevel) {
        ...
        rendered += "</".concat(_tag, ">\n</li>\n");
        nestingLevel--;
      }
    }
    var openTags = (0,_tags__WEBPACK_IMPORTED_MODULE_1__.changedTags)(listItem.getAttributes(), _attributes__WEBPACK_IMPORTED_MODULE_0__.blankAttributes),
      closedTags = (0,_tags__WEBPACK_IMPORTED_MODULE_1__.changedTags)(_attributes__WEBPACK_IMPORTED_MODULE_0__.blankAttributes, listItem.getAttributes());
    rendered += "<li>".concat(openTags).concat(renderContainer(listItem)).concat(closedTags);
...
function renderText(text) {
  ...
  var rendered = attributeIndices.reduce(function (markup, attrIdx, chunkIdx) {
    ...
    var newTags = (0,_tags__WEBPACK_IMPORTED_MODULE_0__.changedTags)(attrs, lastAttributes);
    lastAttributes = attrs;
    return markup + newTags + chunks[chunkIdx];
  }, '');
  return rendered + (0,_tags__WEBPACK_IMPORTED_MODULE_0__.changedTags)(text.getAttributes(), lastAttributes);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   imageUploadLinker: function() { return /* binding */ imageUploadLinker; }
/* harmony export */ });
var contentTypeToExtension = {
  'image/png': 'png',
  'image/jpeg': 'jpeg',
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Persistance: function() { return /* binding */ Persistance; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getDateFromIso: function() { return /* binding */ getDateFromIso; }
/* harmony export */ });
/*
...
__webpack_require__.g.onOpen = _index__WEBPACK_IMPORTED_MODULE_0__.onOpen;
__webpack_require__.g.onInstall = _index__WEBPACK_IMPORTED_MODULE_0__.onInstall;
__webpack_require__.g.showSidebar = _index__WEBPACK_IMPORTED_MODULE_0__.showSidebar;
__webpack_require__.g.authCallback = _index__WEBPACK_IMPORTED_MODULE_0__.authCallback;
__webpack_require__.g.postToWordPress = _index__WEBPACK_IMPORTED_MODULE_0__.postToWordPress;
__webpack_require__.g.devTest = _index__WEBPACK_IMPORTED_MODULE_0__.devTest;
__webpack_require__.g.listSites = _index__WEBPACK_IMPORTED_MODULE_0__.listSites;
__webpack_require__.g.deleteSite = _index__WEBPACK_IMPORTED_MODULE_0__.deleteSite;
__webpack_require__.g.refreshSite = _index__WEBPACK_IMPORTED_MODULE_0__.refreshSite;
__webpack_require__.g.clearSiteData = _index__WEBPACK_IMPORTED_MODULE_0__.clearSiteData;
__webpack_require__.g.include = _index__WEBPACK_IMPORTED_MODULE_0__.include;
__webpack_require__.g.getAuthUrl = _index__WEBPACK_IMPORTED_MODULE_0__.getAuthUrl;
}();
